...
impl StreamControlHandle {
    pub(crate) fn microphone(&self) -> &crate::microphone::Microphone {
        &self.microphone
    }
    ...
    pub(crate) fn microphone_available(&self) -> bool {
        ...
        state.features.as_ref().is_some_and(|p| {
            p.is_windows() && p.supports(crate::feature_ability::Feature::Microphone)
        ...
        let payload = encode_envelope(
            ...
            PbPayload::RpcRequest(
                PbRpcRequest {
                    ...
                    virtual_audio_driver_policy: Some(PolicyRequest {
