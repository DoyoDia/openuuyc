...
use super::*;
use crate::feature_ability::Feature;
...
impl StreamControlHandle {
    ...
    pub(crate) fn set_display_connection_type(&self, kind: crate::control::ControlConnectType) {
        lock(&self.shared).assistance =
            matches!(kind, crate::control::ControlConnectType::Assistance);
    }
    ...
    pub fn apply_display_topology(
        ...
        match action {
            DisplayTopologyAction::Create { width, height } => {
                ...
                request.create_virtual_display = Some(PbCreateVirtualDisplay {
            ...
            DisplayTopologyAction::Exit => {
                ...
                request.quit_super_screen = Some(PbQuitSuperScreen {});
            }
            DisplayTopologyAction::Resolution { screen_id, choice } => {
                let screen = state
                    .screens
                ...
                request.capture_setting = Some(capture);
            }
...
pub(super) struct PbCreateVirtualDisplay {
    ...
    local_resolution: Vec<PbScreenResolution>,
    #[prost(int32, tag = "2")]
    virtual_display_count: i32,
}
#[derive(Clone, PartialEq, prost::Message)]
...
pub(super) struct PbEnterSuperScreen {
    ...
    resolution: Option<PbScreenResolution>,
    #[prost(int32, tag = "3")]
    dpi_scale: i32,
    #[prost(message, optional, tag = "4")]
    enter_fps: Option<PbSuperScreenFps>,
}
#[derive(Clone, PartialEq, prost::Message)]
