use super::*;
use crate::stream_control::{DisplayResolution, DisplayTopologyAction as Action, RemoteScreen};
...
pub(in crate::viewer) fn owns_input(ctx: &egui::Context) -> bool {
    ctx.data(|d| {
...
pub(in crate::viewer) fn request(
    ctx: &egui::Context,
    handle: &StreamControlHandle,
    origin: i32,
    action: Action,
...
pub(in crate::viewer) fn local_parameters(
    ctx: &egui::Context,
    handle: &StreamControlHandle,
    size: Option<(u32, u32)>,
) -> (u32, u32, u32) {
