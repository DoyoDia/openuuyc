...
pub(crate) use crate::audio::encoder::Config as Encoding;
use crate::audio::encoder::create_encoder as make_encoder;
    ...
    f32: cpal::FromSample<T>,
{
    ...
    let mut resampler = crate::audio::dsp::Resampler::with_rates(config.sample_rate, RATE)?;
