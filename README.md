...
从 [Releases](https://github.com/djkcyl/openuuyc/releases) 下载 `OpenUUYC.exe`，双击运行，扫码或短信登录后选择设备连接。被控设备需要运行 UU 远程。
...
目前支持 Windows x64，暂不支持文件传输、剪贴板同步和本机被控。具体功能以所用版本的 Release 说明为准。
